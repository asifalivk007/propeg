...
import NucleaseSense from './components/NucleaseSense_gpeg';
import NucleaseAntiSense from './components/NucleaseAntiSense_gpeg';
...
const PegRNAVisualization = ({ spacer, pbs, rtTemplate, strand, scaffoldMod }) => {
...
if (typeof window !== 'undefined') {
    window.GpegRNAVisualization = PegRNAVisualizationAPI;
}
